...
|--------------------|---------------------|----------------------|----------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Audio Level        | yes                 | Stereo               | 車載のオーディオに変更する値。例えばオプションの harman / kardon なら　"brended Hi-Fi" らしい (<span style="color: red;">*1</span>) | 純正 (Stock) のオーディオだとこの項目を変更すると音量が小さくなったので、あまり変えないほうが良さそう。                                                                                                                                          |
